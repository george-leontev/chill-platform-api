...
from routers import auth_router, post_router, friend_router, message_router, profile_router, user_router, support_router
...
router.include_router(user_router.router, tags=["Users / Stats"])
router.include_router(support_router.router, tags=["Support"])